package edu.neu.ece.devicedescriptiongenerator.test;
...
public class Test1 {
	 ...
	 *             If an ontology cannot be created then subclasses of this class
	 *             will describe the reasons.
	 */
	public void processRestrictions() throws OWLOntologyCreationException {
		...
		OWLClass device = man.getOWLDataFactory().getOWLClass(deviceIRI);
